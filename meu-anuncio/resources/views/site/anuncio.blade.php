...
<div class="container">
    ...
    <div class="row section">
        ...
        <div class="col s12 m4">
            ...
            <p>
                <a href="https://web.facebook.com/sharer/sharer.php?p[url]={{ route('site.anuncio', [$anuncio->id, Illuminate\Support\Str::slug($anuncio->titulo, '_')]) }}" target="_blank"><img src="{{ asset('img/facebook.png') }}" title="Compartilhe este anúncio" width="32"></a>
                <a href="http://www.twitter.com/share?url={{ route('site.anuncio', [$anuncio->id, Illuminate\Support\Str::slug($anuncio->titulo, '_')]) }}" target="_blank"><img src="{{ asset('img/twitter.png') }}" title="Tuíte este anúncio" width="32"></a>
            </p>
        </div>
    </div>
    <div class="row section">
