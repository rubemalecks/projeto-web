<div class="input-field">
    <input type="text" class="validate" id="titulo" name="titulo" value="{{ isset($anuncio->titulo) ? $anuncio->titulo : '' }}">
    <label for="titulo">Título</label>
</div>
<div class="input-field">
    <input type="text" class="validate" id="descricao" name="descricao" value="{{ isset($anuncio->descricao) ? $anuncio->descricao : '' }}">
...
<div class="input-field">
    <input type="text" class="validate" id="endereco" name="endereco" value="{{ isset($anuncio->endereco) ? $anuncio->endereco : '' }}">
...
<div class="input-field">
    <input type="number" class="validate" id="valor" name="valor" min="0" value="{{ isset($anuncio->valor) ? number_format($anuncio->valor, 2, '.', '') : '' }}" step="0.01">
    <label for="valor">Valor (Ex.: 324,90)</label>
</div>
<div class="input-field">
    <textarea id="detalhes" name="detalhes" class="materialize-textarea">{{ isset($anuncio->detalhes) ? $anuncio->detalhes : '' }}</textarea>
