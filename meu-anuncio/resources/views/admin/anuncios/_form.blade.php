...
<div class="input-field">
    <select name="finalidade" id="finalidade">
        <option value="Aluguel" {{ isset($anuncio->finalidade) && $anuncio->finalidade == "Aluguel" ? " selected" : ""
            }}>Aluguel</option>
        <option value="Troca" {{ isset($anuncio->finalidade) && $anuncio->finalidade == "Troca" ? " selected" : ""
            }}>Troca</option>
        <option value="Venda" {{ isset($anuncio->finalidade) && $anuncio->finalidade == "Venda" ? " selected" : ""
            }}>Venda</option>
    </select>
...
<div class="input-field">
    <select name="categoria_id" id="categoria_id">
        ...
        <option value="{{ $categoria->id }}" {{ isset($anuncio->categoria_id) && $anuncio->categoria_id ==
            $categoria->id ? " selected" : "" }}>{{ $categoria->titulo }}</option>
        @endforeach
    </select>
...
<div class="input-field">
    <select name="municipio_id" id="municipio_id">
        ...
        <option value="{{ $municipio->id }}" {{ isset($anuncio->municipio_id) && $anuncio->municipio_id ==
            $municipio->id ? " selected" : "" }}>{{ $municipio->nome }} - {{ $municipio->sigla_uf }}</option>
        @endforeach
    </select>
...
<div class="input-field">
    <select name="status" id="status">
        <option value="Rascunho" {{ isset($anuncio->status) && $anuncio->status == "Rascunho" ? " selected" : ""
            }}>Rascunho</option>
        <option value="Publicado" {{ isset($anuncio->status) && $anuncio->status == "Publicado" ? " selected" : ""
            }}>Publicado</option>
    </select>
