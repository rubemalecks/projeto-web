...
<div class="input-field">
    <input type="text" class="validate" id="link" name="link" value="{{ isset($slide->link) ? $slide->link : '' }}">
...
<div class="input-field">
    <select name="status" id="status">
        <option value="Rascunho" {{ isset($slide->status) && $slide->status == "Rascunho" ? " selected" : "" }}>Rascunho
        </option>
        <option value="Publicado" {{ isset($slide->status) && $slide->status == "Publicado" ? " selected" : ""
            }}>Publicado</option>
    </select>
